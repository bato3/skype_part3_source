...
Example Elliptic Curve Diffie-Hellman program for constrained environments. Uses point compression.
...
lib /OUT:miracl.lib miracl.lib mrecgf2m.obj
del mr*.obj

Create the program

cl /O2 ecdh.c miracl.lib
...
/* Specify base 16 here so that HEX can be read in directly without a base-change */
    ...
    promptr=0;
    init_big_from_rom(B,WORDS,rom,24,&promptr);  /* Read in curve parameter B from ROM */
