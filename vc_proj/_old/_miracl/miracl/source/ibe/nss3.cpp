/*
   ...
   Compile as 
   cl /O2 /GX /DZZNS=16 nss3.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib
   using COMBA build
...
//
// Calculate the "second half" values ar the same time, and store them
//
