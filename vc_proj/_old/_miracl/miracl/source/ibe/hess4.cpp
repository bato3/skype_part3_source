/*
   ...
   Compile as 
   cl /O2 /GX /DZZNS=8 hess4.cpp zzn4.cpp zzn2.cpp ecn2.cpp big.cpp zzn.cpp 
   ecn.cpp miracl.lib
...
// hash Identities to curve point
    ...
    if (!power_tate(Server,sA,t1,cf,Fr,a,res)) cout << "Trouble" << endl;
    ...
    if (!power_tate(sS,Alice,t1,cf,Fr,s,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!power_tate(Server,sB,t1,cf,Fr,b,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!power_tate(sS,Bob,t1,cf,Fr,s,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
