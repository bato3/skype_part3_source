 ...
 *
   ...
   Compile as 
   cl /O2 /GX /DZZNS=12 ake12blsa.cpp zzn12.cpp zzn6a.cpp ecn2.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib
   using COMBA build
...
int main()
{
    ...
    mip->IOBASE=16;
    x= (char *)"4800000000052FDE";  // found by BLSK12.CPP
    ...
    Server=hash_and_map2((char *)"Server",cf);
