 ...
 *
   ...
   Compile as 
   cl /O2 /GX /DZZNS=16 ake6fsta.cpp zzn6.cpp zzn3.cpp big.cpp zzn.cpp ecn.cpp miracl.lib
   using COMBA build
...
BOOL fast_pairing(ECn& P,ECn& Q,Big& q,Big &x,ZZn3& r)
{ 
...
// sextic twist
    ...
    if (!fast_pairing(sA,Server,q,x,res)) cout << "Trouble" << endl;
    ...
    if (!fast_pairing(Alice,sS,q,x,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn3)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!fast_pairing(sB,Server,q,x,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn3)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!fast_pairing(Bob,sS,q,x,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn3)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!fast_pairing(Alice,sB,q,x,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn3)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
    ...
    if (!fast_pairing(sA,Bob,q,x,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn3)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
