...
int udp_talk(char *remoteip, unsigned short remoteport, char *buf, int len, char *result, int result_maxlen){
	int s, ret, addrlen;
...
int udp_recv(char *remoteip, unsigned short remoteport, char *result, int result_maxlen){
	int s, ret, addrlen;
	struct sockaddr_in addr;
	WSADATA wsaDATA;
	fd_set rfds;
