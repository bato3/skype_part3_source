...
struct self_s {
	...
	char *heap_main_alloc_struct_array[100*4];
	uint heap_main_alloc_struct_array_size[100*4];
	uint heap_main_alloc_struct_count;
	uint heap_main_current_alloc_struct_count;
	...
	uint heap_alloc_struct_array_size[100*4];
	uint heap_alloc_struct_array_mainptr[100*4];
