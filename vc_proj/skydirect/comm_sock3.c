...
int udp3_talk_tmp(char *remoteip, unsigned short remoteport, char *buf, int len, char *result, int result_maxlen, int *retsock){
	int s, ret, addrlen;
...
int udp3_talk(char *remoteip, unsigned short remoteport, char *buf, int len, char *result, int result_maxlen){
	int s, ret, addrlen;
	struct sockaddr_in addr;
