...
int encode41_sess2pkt2_recurs(char *globalptr, char *buf, int buf_limit_len);
int encode41_sess2pkt2_recurs2(char *globalptr, char *buf, int buf_limit_len);
int encode41_sess2pkt2_recurs3(char *globalptr, char *buf, int buf_limit_len);


extern uint DEBUG_LEVEL;


int encode41_sess2pkt1_ack(char *globalptr, char *buf, int buf_limit_len){
	uint session_id;
	uint session_cmd;
	int buf_len;
...
int encode41_sess2pkt2(char *globalptr, char *buf, int buf_limit_len){
	struct blob_s blob;
	uint session_id;
	uint session_cmd;
	int buf_len;
	...
	intbuf_len=encode41_sess2pkt2_recurs(globalptr,intbuf,sizeof(intbuf));
...
int encode41_sess2pkt2_recurs(char *globalptr, char *buf, int buf_limit_len){
	...
	blob.obj_index = 2;
    blob.obj_data = 0;
	blob.data_ptr = (int)global->CHAT_STRING;
	blob.data_size = strlen(global->CHAT_STRING)+1;
    ...
    // blob6 recursive 41
	intbuf_len=encode41_sess2pkt2_recurs2(globalptr,intbuf,sizeof(intbuf));
	if (intbuf_len == -1) {	return -1;	};
...
int encode41_sess2pkt2_recurs2(char *globalptr, char *buf, int buf_limit_len){
    ...
    // blob1 recursive 41
	intbuf_len=encode41_sess2pkt2_recurs3(globalptr,intbuf,sizeof(intbuf));
	if (intbuf_len == -1) {	return -1;	};
...
int encode41_sess2pkt3(char *globalptr, char *buf, int buf_limit_len){
	struct blob_s blob;
	uint session_id;
	uint session_cmd;
	int buf_len;
...
int encode41_sess2pkt4_ack(char *globalptr, char *buf, int buf_limit_len){
	uint session_id;
	uint session_cmd;
	int buf_len;
