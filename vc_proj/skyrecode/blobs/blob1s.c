...
int encode41_sess1pkt1_recurs(char *globalptr, char *buf, int buf_limit_len){
	struct blob_s blob;
	int buf_len;
...
int encode41_sess1pkt1(char *globalptr, char *buf, int buf_limit_len, char *chatstr){
	struct blob_s blob;
	uint session_id;
	uint session_cmd;
	int buf_len;
	...
	intbuf_len=encode41_sess1pkt1_recurs(globalptr, intbuf,sizeof(intbuf));
...
int encode41_sess1pkt2(char *globalptr, char *buf, int buf_limit_len){
	struct blob_s blob;
	uint session_id;
	uint session_cmd;
	int buf_len;
