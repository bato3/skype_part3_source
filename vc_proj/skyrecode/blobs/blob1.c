...
int encode41_setup1pkt(char *globalptr, char *buf, int buf_limit_len){
    ...
    blob.obj_type = 0;
	blob.obj_index = 3;
    blob.obj_data = global->LOCAL_SESSION_ID;
	blob.data_ptr = 0;
	blob.data_size = 0;
	...
	blob.obj_index = 1;
    blob.obj_data = 0;
	blob.data_ptr = (uint)global->INIT_UNK;
	...
	blob.obj_index = 9;
    blob.obj_data = 0;
	blob.data_ptr = global->BLOB_1_9_ptr;
	blob.data_size = global->BLOB_1_9_size;
	...
	blob.obj_index = 0;
    blob.obj_data = 0;
	blob.data_ptr = (int)global->REMOTE_NAME;
	blob.data_size = strlen(global->REMOTE_NAME)+1;
