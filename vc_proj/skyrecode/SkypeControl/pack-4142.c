/*\
|*|
|*| Skype 4142 Compression v1.003 by Sean O'Neil.
...
void pack_42_769CA0(u32 ctx)
{
  ...
  for ( ; *(u32 *)(ctx + 8) <= 0x800000; *(u32 *)(ctx + 4) = (v1 & 0x7FFFFF) << 8 )
  {
    ...
    else
    {
	  ...
	  // 
      for ( ; *(u32 *)(ctx + 13); --*(u32 *)(ctx + 13) ) Add_Byte(ctx, (char)255);
      v1 = *(u32 *)(ctx + 4);
      *(u8 *)(ctx + 12) = (u8) (v1 >> 23);
    }
    *(u32 *)(ctx + 8) <<= 8;
...
void pack_42_expand_ctx_87F0F0 (u32 ctx)
{
...
u32 packed_dword_chars_714880(u32 the_dword)
{
  u32 chars; // eax@1
...
u32 get_41_packed_length_7155B0(u32 * thing)
{
  ...
  chars = packed_dword_chars_714880 (thing[1]) + 1;
  switch ( thing[0] )
  {
    case 0:
      chars += packed_dword_chars_714880 (thing[2]);
      break;
    case 1:
      chars += 8;
      break;
    case 2:
      ...
      break;
    case 4:
      chars += packed_dword_chars_714880 (thing[3]);
    case 3:
      chars += thing[3];
      break;
    case 5:
      chars += get_4142_packed_length_7148D0((u32 *) thing[2], 0);
      break;
    case 6:
      ptr = thing[2];
	  dwords = thing[3] >> 2;
      chars += packed_dword_chars_714880(dwords);
      for (i = 0; i < dwords; ) chars += packed_dword_chars_714880(*(u32 *)(ptr + 4 * i++));
	  break;
    default:;
  }
  return chars;
...
u32 get_4142_packed_length_7148D0(u32 * list, char pack42)
{
  ...
  v5 = dword(list,12);
  total_length = packed_dword_chars_714880(list[3]) + 1;
  for (v7 = 0; v7 < list[3]; v7++)
  {
	total_length += get_41_packed_length_7155B0((u32 *)(list[1]+v7*16));
  }
  return total_length;
}
...
u32 pack_42_copy_thing_9FF4E0(u32 * ctx, u32 *ptr, u32 i)
{
  ...
  memmove((void *)(ctx[32] + 4 * i + 4), (void *)(ctx[32] + 4 * i), 4 * (ctx[33]++ - i));
  result = 4 * i + ctx[32];
...
u32 pack_42_find_code_76A070(u32 *code_array, u32 look_for)
{
  ...
  {
    v5 = code_array[i];
    memmove(code_array + 1, code_array, 4 * i);
    *code_array = v5;
  }
  return i;
}
...
LABEL_40:
      switch ( list[0] )
      {
        ...
        case 4:
          ...
          if ( *(u32 *)(ctx + 0x3F6) >= *(u32 *)(ctx + 0x3FA) ) pack_42_expand_ctx_87F0F0(v11);
          v64 = *(u32 *)(ctx + 0x3F6);
        ...
        case 1:
          ...
          {
            pack_42_expand_ctx_87F0F0 (ctx + 0x1F2);
          }
          v68 = *(u32 *)(ctx + 0x3F6);
        ...
        case 2:
          ...
          if ( !v75 ) pack_42_expand_ctx_87F0F0 (v11);
          v76 = *(u32 *)(ctx + 0x3F6);
