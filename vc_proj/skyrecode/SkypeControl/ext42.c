...
// chatsync prepare   //
////////////////////////
int main_unpack_sync_first(u8 *buf, int buf_len, u8 *chatstr, unsigned int blob_sid) {
	int ret=0;
...
;
	...
	*/
	...
	skype_thing	mythings[] = {
		{00, 0x01, 0xAAAAAAAA/*0x918320B8*/, 0x00},
		{00, 0x03, 0x00, 0x00},
...
//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
int main_unpack_sync_confirm(u8 *buf, int buf_len, int seq, unsigned int blob_sid) {
	int ret=0;
	...
	/*
	u8 test2[]=
"\xFF\xEF\x03\x6D\x41\x03\x00\x01\xB8\xC1\x8C\x8C\x09\x00\x03\x00"
"\x00\x08\x01\x1E\xDE"
;
	u32 test2_len=sizeof(test2)-1;
	*/
...
int main_unpack_sync_24(u8 *buf, int buf_len) {
	int ret=0;
...
int main_unpack_sync_27(u8 *buf, int buf_len) {
	int ret=0;
