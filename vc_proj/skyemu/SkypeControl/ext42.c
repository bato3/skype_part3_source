...
extern u32 node_req_addr1;
extern u16 node_req_port1;
extern u32 node_req_addr2;
extern u16 node_req_port2;
...
// pack
//
int main_pack_into_tmp (skype_thing *m1ythings, int m1ythings_len, skype_thing *m1ythings2, int m1ythings2_len, u8 *outdata, u32 maxlen) {
	u32				list_size = 1;
	u32				packed_bytes;

	char req_user[]="partnersingrants";
	u32 dw[2]={0x10,0x0B};
