// chatsync.c : Defines the entry point for the console application.
//
...
extern int make_tcp_client_sess1_pkt4o(char *globalptr, char *pkt, int *pkt_len);
...
int main_skypeclient_tcpconnect(_MIPD_ char *globalptr){
	...
	make_tcp_client_sess1_pkt4o(globalptr, (char *)pkt, &pkt_len);
	resp_len=tcp_talk(destip,destport,pkt,pkt_len,resp,0);
